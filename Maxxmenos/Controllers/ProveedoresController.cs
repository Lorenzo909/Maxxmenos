...
namespace Maxxmenos.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Compania,Representante,Telefono")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,Compania,Representante,Telefono")] Proveedor proveedor)
        {
